...
void Player::AimUpdate() {
	...
	//
	//XMMATRIX matInvVPV = XMMatrixInverse(nullptr, matViewProjectionViewport);
	//XMVECTOR testVec = {raticle2D.m128_f32[0], raticle2D.m128_f32[1], 0};

	//testVec = XMVector3TransformNormal(testVec, matInvVPV);
